    ...
    <div className='header-box'>
      ...
      <div className='header-logo-box'>
        ...
        <div className='header-icons-box'>
          <a><img src={headerImages.alertsIcon}></img></a>
          <a><img src={headerImages.searchIcon}></img></a>
          <a><img src={headerImages.heartIcon}></img></a>
          <a><img src={headerImages.cartIcon}></img></a>
        </div>
      </div>
    </div>
  )
